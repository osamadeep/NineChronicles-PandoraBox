...
namespace Planetarium.Nekoyume.Editor
{
    public static class ReportAnything
    {
        ...
        public static void ShopItemCheckMimisbrunnrReport()
        {
            ...
            Debug.Log(
                $"[Report Anything] Made with mimisbrunnr recipe items in sell: {mimisCount}/{sellEquipments.Length}");
            ...
            Debug.Log(
                $"[Report Anything] Made with mimisbrunnr recipe items in buy: {mimisCount}/{buyEquipments.Length}");
