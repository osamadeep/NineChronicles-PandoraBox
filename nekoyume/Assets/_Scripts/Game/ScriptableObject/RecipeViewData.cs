...
namespace Nekoyume.Game.ScriptableObject
{
    ...
    public class RecipeViewData : UnityEngine.ScriptableObject
    {
        ...
        public class Data
        {
            ...
            [field: SerializeField] public Material LevelTextMaterial { get; private set; }

            [field: SerializeField] public Color LevelBgHsvTargetColor { get; private set; }
        ...
        [SerializeField] private List<Data> datas = null;

        [SerializeField] private int fallbackGrade;
