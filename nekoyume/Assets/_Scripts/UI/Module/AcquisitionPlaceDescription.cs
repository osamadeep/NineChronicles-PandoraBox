...
namespace Nekoyume.UI.Module
{
    ...
    {
        [SerializeField] private RectTransform leftDeco;

        [SerializeField] private RectTransform rightDeco;

        [SerializeField] private RectTransform contentsRectTransform;
        ...
        public void Show(RectTransform parentTransform, RectTransform helpButtonTransform)
        {
            ...
            if (parentScreenPos.x <= _mainCamera.pixelWidth / 2)
            {
                ...
                contentsRectTransform.MoveToRelatedPosition(helpButtonTransform, PivotPresetType.BottomRight,
                    DescriptionOffset);
            ...
            else
            {
                ...
                contentsRectTransform.MoveToRelatedPosition(helpButtonTransform, PivotPresetType.BottomLeft,
                    -DescriptionOffset);
                var contentAnchoredPosition = contentsRectTransform.anchoredPosition;
                contentAnchoredPosition.y = 0;
                contentsRectTransform.anchoredPosition = contentAnchoredPosition;
