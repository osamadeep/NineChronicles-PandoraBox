...
namespace Nekoyume.UI.Module
{
    public class AvatarCP : MonoBehaviour
    {
        ...
        [SerializeField] private DigitTextTweener cpTextValueTweener = null;

        [SerializeField] private GameObject additionalCpArea = null;

        [SerializeField] private TextMeshProUGUI additionalCpText = null;
