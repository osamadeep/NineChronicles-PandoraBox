...
namespace Nekoyume.UI.Module
{
    ...
    {
        [SerializeField] private OptionTagDataScriptableObject optionTagData = null;

        [SerializeField] private UIHsvModifier background;

        [SerializeField] private List<Image> optionTagImages = null;
