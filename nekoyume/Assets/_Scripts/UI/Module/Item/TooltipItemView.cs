...
namespace Nekoyume.UI.Module
{
    ...
    {
        [SerializeField] private SpineTooltipDataScriptableObject tooltipDataScriptableObject;

        [SerializeField] private BaseItemView baseItemView;

        [SerializeField] private ParticleSystem gradeEffect;

        [SerializeField] private Color levelLimitedItemColor;
