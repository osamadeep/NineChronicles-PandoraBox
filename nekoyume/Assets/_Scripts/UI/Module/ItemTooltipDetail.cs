...
namespace Nekoyume.UI.Module
{
    public class ItemTooltipDetail : MonoBehaviour
    {
        ...
        [SerializeField] private TooltipItemView itemView;

        [SerializeField] private IconArea iconArea;

        [SerializeField] private DescriptionArea descriptionArea;

        [SerializeField] private List<StatView> statViewList;

        [SerializeField] private GameObject optionSpacer;

        [SerializeField] private GameObject optionAreaRoot;

        [SerializeField] private TextMeshProUGUI tradableText;

        [SerializeField] private List<StatRow> statRows;

        [SerializeField] private List<SkillView> skills;
