...
namespace Nekoyume.UI.Module
{
    public class RecipeView : MonoBehaviour
    {
        ...
        [SerializeField] private UIHsvModifier levelBg = null;

        [SerializeField] private TextMeshProUGUI normalLevelText = null;

        [SerializeField] private TextMeshProUGUI lockedLevelText = null;
