...
namespace Nekoyume.UI.Scroller
{
    ...
    public class GuidedQuestCell : MonoBehaviour
    {
        ...
        // NOTE: 콘텐츠 텍스트의 길이가 UI를 넘어갈 수 있기 때문에 flowing text 처리를 해주는 것이 좋겠습니다.
        [SerializeField] private TextMeshProUGUI effectedContentText = null;

        [SerializeField] private Image effectedBodyImage = null;

        // NOTE: 가이드 퀘스트 보상 아이콘의 연출 스펙에 따라서 별도로 XxxItemView를 만들어서 사용합니다.
        [SerializeField] private List<StageRewardItemView> rewards = null;

        [SerializeField] private Button bodyButton = null;

        // NOTE: 셀이 더해지고 빠지는 연출이 정해지면 더욱 개선됩니다.
        [SerializeField] private AnchoredPositionSingleTweener showingAndHidingTweener = null;

        [SerializeField] private TransformLocalScaleTweener inProgressTweener = null;
