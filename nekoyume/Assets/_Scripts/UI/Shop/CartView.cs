...
namespace Nekoyume.UI.Module
{
    ...
    public class CartView : MonoBehaviour
    {
        ...
        [SerializeField] private List<ShopCartItemView> cartItems = new List<ShopCartItemView>();

        [SerializeField] private Button historyButton;

        [SerializeField] private Button showCartButton;

        [SerializeField] private ConditionalButton hideCartButton;

        [SerializeField] private ConditionalButton buyButton;
        ...
        private void Awake()
        {
            ...
            showCartButton.onClick.AddListener(() => { _onClickShowCart?.Invoke(); });
