...
namespace Nekoyume.UI
{
    ...
    public class SweepPopup : PopupWidget
    {
        ...
        [SerializeField] private ConditionalButton cancelButton;

        [SerializeField] private List<Button> addCountButtons;
        ...
        [SerializeField] private TextMeshProUGUI inventoryApStoneText;

        [SerializeField] private TextMeshProUGUI useApStoneText;
