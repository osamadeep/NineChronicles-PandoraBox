...
namespace Nekoyume.UI
{
    ...
    {
        [SerializeField] private TimeMachineRewind sweepRewind;

        [SerializeField] private TimeMachineRewind loadingRewind;

        [SerializeField] private PlayableDirector playableDirector;

        [SerializeField] private ConditionalButton okButton;

        [SerializeField] private ConditionalButton mainButton;

        [SerializeField] private SkeletonGraphic spine;

        [SerializeField] private Animator background;

        [SerializeField] private Image playCountBar;
        ...
        [SerializeField] private Transform titleDecoContainer;

        [SerializeField] private List<SweepItem> items;
        ...
        [SerializeField] private int maxPlayCount = 11;
