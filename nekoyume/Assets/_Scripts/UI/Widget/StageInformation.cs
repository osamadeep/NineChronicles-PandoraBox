...
namespace Nekoyume.UI
{
    ...
    {
        [SerializeField] private HelpButton stageHelpButton;

        [SerializeField] private TextMeshProUGUI titleText;

        [SerializeField] private List<VanillaCharacterView> monstersAreaCharacterViews;

        [SerializeField] private List<StageRewardItemView> rewardsAreaItemViews;
        ...
        [SerializeField] private WorldMapWorld world;

        [SerializeField] private GameObject buttonNotification;
